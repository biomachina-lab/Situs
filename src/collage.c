...
static void multi_rot_euler_trans (unsigned, unsigned, unsigned, PDB *, PDB *, double, double, double, double, double, double);
...
/* global variables */
typedef struct { double score; double pos[3]; double euler[3]; } FIT;  
typedef struct { unsigned long ifft; unsigned long ireal; unsigned ix; unsigned iy; unsigned iz; } POS;
...
/* compare to colores 'powell_correlation' */
  ...
  scratch->curr_shift[0]=0; scratch->curr_shift[1]=0; scratch->curr_shift[2]=0;
